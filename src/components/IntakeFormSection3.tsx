...
export function IntakeFormSection3({
  form
}: {
  form: any;
}) {
  ...
  useEffect(() => {
    if (neckPain === "1") {
      ...
      const startText = neckPainStart === "1" ? "same day" : neckPainStart === "2" ? "next day" : "few days later";
      const initialSeverityText = neckPainInitialSeverity === "1" ? "mild" : neckPainInitialSeverity === "2" ? "moderate" : "severe";
      const currentSeverityText = neckPainCurrentSeverity === "1" ? "mild" : neckPainCurrentSeverity === "2" ? "moderate" : neckPainCurrentSeverity === "3" ? "severe" : "resolved";
  ...
  return <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <FormField control={form.control} name="neckPain" render={({
          field
          ...
          {neckPain === "1" && <>
              <FormField control={form.control} name="neckPainStart" render={({
            field
                    ...
                    <FormControl>
                      <div className="flex flex-col space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox checked={field.value === "3"} onCheckedChange={() => field.onChange("3")} />
              ...
              <FormField control={form.control} name="neckPainInitialSeverity" render={({
            field
          }) => <FormItem className="space-y-3">
              ...
              <FormField control={form.control} name="hadPriorNeckPain" render={({
            field
          }) => <FormItem className="space-y-3">
              ...
              {hadPriorNeckPain === "1" && <div className="space-y-4 border p-4 rounded-md">
                  ...
                  <FormField control={form.control} name="accidentNeckPainPercentage" render={({
              field
            }) => <FormItem>
                        <FormLabel>Percentage due to this accident (%)</FormLabel>
                        <FormControl>
                          <Input type="number" placeholder="e.g. 50" min="0" max="100" {...field} />
                        </FormControl>
                        <FormDescription>
                  ...
                  <FormField control={form.control} name="priorNeckPainPercentage" render={({
              field
            }) => <FormItem>
        ...
        <div className="space-y-4">
          {neckPain === "1" && <>
              <FormField control={form.control} name="neckPainCurrentSeverity" render={({
            field
          }) => <FormItem className="space-y-3">
                    ...
                    <FormControl>
                      <div className="flex flex-col space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox checked={field.value === "4"} onCheckedChange={() => field.onChange("4")} />
              ...
              {neckPainCurrentSeverity === "4" && <FormField control={form.control} name="neckPainResolveDays" rules={{
            required: "This field is required when pain is resolved"
          }} render={({
            field
          }) => <FormItem>
