...
export const MedicalRecordsReviewSection = ({ styles }: MedicalRecordsReviewSectionProps) => {
  return (
    <View style={styles.subsection}>
      <Text style={styles.sectionHeader}>Section 11 - Medical Records Review</Text>
      
      <View style={styles.fieldRow}>
        <View style={[styles.fieldColumn, { flex: 1 }]}>
          <Text style={styles.fieldLabel}>11.1 Review Status</Text>
      ...
      <View style={{ marginTop: 15 }}>
        <Text style={styles.fieldLabel}>11.2 Re-examination Recommendation</Text>
        <Text style={styles.fieldValue}>
      ...
      <View style={{ marginTop: 15 }}>
        <Text style={styles.fieldLabel}>11.3 Employment Prospects</Text>
        <Text style={styles.fieldValue}>
