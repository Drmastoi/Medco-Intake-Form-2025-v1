  ...
  return (
    <View style={styles.subsection}>
      ...
      <View style={{ marginBottom: 10 }}>
        <Text style={styles.fieldLabel}>13.1 Type of Treatment</Text>
      ...
      {formData.other?.treatment?.hasTreatment && (
        <>
          <View style={{ marginBottom: 10 }}>
            <Text style={styles.fieldLabel}>13.2 Frequency</Text>
            <Text style={styles.fieldValue}>
          ...
          <View style={{ marginBottom: 10 }}>
            <Text style={styles.fieldLabel}>13.3 Duration</Text>
            <Text style={styles.fieldValue}>
          ...
          <View style={{ marginBottom: 10 }}>
            <Text style={styles.fieldLabel}>13.4 Treatment Status</Text>
            <Text style={styles.fieldValue}>
