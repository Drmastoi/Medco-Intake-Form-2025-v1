    ...
    <View style={styles.section}>
        ...
        <View style={styles.summaryBox}>
          {data?.neckPain?.hasInjury ? (
            <Text style={styles.summaryText}>
              ...
              {data.neckPain.hadPrior ? " The claimant had a prior history of neck pain before this accident." : ""}
            </Text>
          ) : (
            <Text style={styles.summaryText}>
      ...
      {data?.headache?.hasInjury && (
        <View style={styles.subsection}>
          ...
          <View style={styles.summaryBox}>
            <Text style={styles.summaryText}>
              The claimant reported headaches starting {data.headache.start === "immediately" ? "immediately after the accident" : 
              data.headache.start === "hours" ? "within hours of the accident" : 
              data.headache.start === "day" ? "the day after the accident" : 
              data.headache.start === "days" ? "a few days after the accident" : "after the accident"}.
              Initial severity was {data.headache.initialSeverity === "1" ? "mild" : 
              data.headache.initialSeverity === "2" ? "moderate" : 
              data.headache.initialSeverity === "3" ? "severe" : "very severe"} and current severity is {
              data.headache.currentSeverity === "1" ? " mild" : 
              data.headache.currentSeverity === "2" ? " moderate" : 
              data.headache.currentSeverity === "3" ? " severe" : " very severe"}.
            </Text>
          </View>
        </View>
      )}
